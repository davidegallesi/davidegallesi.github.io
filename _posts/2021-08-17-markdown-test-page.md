...
1. Ho provato a modificare il background dei blocchi di codice. Non sembra che funzioni.
2. Sto utilizzando le varibili `SCSS` e ora sembra funzionare tutto.
3. Dovrò ripulire e sistemare un poco il codice per renderlo più leggibile.

Ora sto provando a fare il deploy su netlify senza pubblicare, vediamo se funziona.

Provo anche a inserire un'immagine.

Ora sto modificando il file da remoto utilizzando un laptop Linux. Vediamo se funziona.

Molto strano, vediamo... non capisco.

Funziona.



Ora sto riprovando a scrivere.
